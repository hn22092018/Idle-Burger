...
namespace SDK
{
    public class ABIAppsflyerManager : MonoBehaviour, IAppsFlyerConversionData
    {
        ...
        #region Tracking
        public const string af_inters_logicgame = "af_inter_ad_eligible";
        public const string af_inters_successfullyloaded = "af_inter_api_called";
        public const string af_inters_displayed = "af_inter_ad_completed";

        public const string af_inters_show_count = "af_inters_show_count_";

        public const string af_rewarded_logicgame = "af_rewarded_ad_eligible";
        public const string af_rewarded_successfullyloaded = "af_rewarded_api_called";
        public const string af_rewarded_displayed = "af_rewarded_ad_completed";
